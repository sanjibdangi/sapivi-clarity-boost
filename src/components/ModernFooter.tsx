...
export default function ModernFooter() {
  ...
  return (<footer className="bg-secondary text-secondary-foreground relative overflow-hidden"> <div className="absolute inset-0 mesh-gradient opacity-10" />
    ...
    <div className="relative border-t border-white/10 py-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          ...
          <p className="text-white/50 text-sm">CIN: U72900KA2021PTC155725</p>
        </div>
      </div>
    </div>
  </footer>
