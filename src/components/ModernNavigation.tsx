        ...
        <div className="flex justify-between items-center h-20">
          <Link to="/" className="flex items-center gap-3 group shrink-0 min-w-0">
            <motion.div
              ...
              className="shrink-0 w-10 h-10 bg-primary rounded-xl flex items-center justify-center"
            >
              <span className="text-primary-foreground font-bold text-lg">S</span>
            </motion.div>
            <span
              className={`text-xl md:text-2xl font-bold transition-colors leading-none font-display ${
