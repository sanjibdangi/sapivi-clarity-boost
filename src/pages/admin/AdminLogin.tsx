            ...
            {showApiConfig && (
              ...
              >
                <input
                  ...
                  className="w-full px-4 py-3 bg-muted border-2 border-transparent rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary transition-all"
                />

                <p className="text-xs text-muted-foreground mt-2">
                  Enter your MySQL REST API base URL
                </p>
              </motion.div>
            )}
